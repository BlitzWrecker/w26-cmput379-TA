...
int main(int argc, char *argv[]) {
    ...
    // Note: Executing commands via system() poses security risks. It is recommended to use fork() followed by a call to
    // a function from the exec family. The original author may have used system() for simplicity, especially for
